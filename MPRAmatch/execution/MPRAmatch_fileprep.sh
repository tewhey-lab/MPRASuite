...
#**************Step8: Copy input files into setup folder for reference*************

cp ${out}/execution/${now}_${proj}_MPRAmatch/MPRAmatch_${proj}_inputs.json ${out}/${setup}
cp ${acc_file} ${out}/${setup}
cp ${fasta} ${out}/${setup}
