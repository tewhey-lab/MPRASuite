...
stats_out <- read.delim(stats_out_file, stringsAsFactors = F, header=F, sep = "\t", check.names=FALSE)
acc <- read.delim(acc_file, stringsAsFactors = F, header=F, check.names=FALSE)
